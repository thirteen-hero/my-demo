...
// module对象在dependency graph体系下的补充信息,包含模块对象的incomingConnections和outgoingConnections
class ModuleGraphModule {
	constructor() {
		/** @type {IncomingConnections} */
    // 指向模块本身的moduleGraphConnection集合,即谁引用了模块自身
		this.incomingConnections = new SortableSet();
		/** @type {OutgoingConnections | undefined} */
    // 该模块对外的依赖,即该模块引用了其他哪些模块
...
/** @typedef {TODO} Meta */
// 记录dependency graph信息的容器,记录构建过程中涉及到的所有module、dependency对象，以及这些对象互相之间的引用
class ModuleGraph {
	constructor() {
		/**
		 ...
		 * @private
		 */
    // 记录dependency对象与moduleGraphConnection对象之间的映射关系,后续的处理中可以基于这层映射迅速找到dependency实例对应的引用与被引用者
		this._dependencyMap = new WeakMap();
		/**
		 * @type {Map<Module, ModuleGraphModule>}
		 * @private
		 */
    // 记录module与moduleGraphModule之间的映射关系
