          ...
          // 遍历module对象
              ...
              // 当前module没有缓存 将module加入queue中
						...
						err => {
							 ...
							 * @returns {void}
							 */
              // 遍历module对象的dependencies数组,找到所有HarmonyExportXXXDependency类型的依赖对象,将其转换为exportInfo对象并记录的ModuleGraph对象中
